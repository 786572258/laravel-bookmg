        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    {!! Form::model($article, ['route' => ['admin.article.update', $article->id], 'method' => 'put','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                {!! Form::text('tags', '', ['class' => 'tokenfield form-control','placeholder'=>'回车确定','id'=>'tags']) !!}
